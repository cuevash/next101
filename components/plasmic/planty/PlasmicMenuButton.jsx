...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: CtOGPAYYB9Obua/css
import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: Zcdoo9TY0-n4Ht/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: xeZvLonSNDSbcx/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, "expanded", "expanded") ? true : true) ? (
          <BarsIcon
            className={classNames(projectcss.all, sty.svg__tfdcT, {
              [sty.svgexpanded__tfdcTcWPlb]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant(variants, "expanded", "expanded") ? true : true) ? (
          <TimesIcon
            className={classNames(projectcss.all, sty.svg__oozx5, {
              [sty.svgexpanded__oozx5CWPlb]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
